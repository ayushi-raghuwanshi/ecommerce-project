<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
        ...
        <a href="index.html" class="app-brand-link">
            <span class="app-brand-logo demo">
                <img src="{{ asset('admin/assets/img/logo.png') }}" alt="logo"
                    style="width:45%;height:45%;margin-left:15%">
            </span>
        </a>
    ...
    <ul class="menu-inner py-1">
        ...
        <!-- Layouts -->
        <li class="menu-item {{ request()->is('admin/user-management*') ? 'active open' : '' }}">
            <a href="javascript:void(0);" class="menu-link menu-toggle">
                <i class="menu-icon tf-icons bx bx-layout"></i>
                <div data-i18n="Layouts">User Management</div>
            </a>
            <ul class="menu-sub">
                <li class="menu-item {{ request()->route()->getName() == 'admin.permission.list'? 'active': '' }}">
                    <a href="{{ route('admin.permission.list') }}" class="menu-link">
                        <div data-i18n="Without menu">Permissions</div>
                    </a>
                </li>
                <li class="menu-item {{ request()->route()->getName() == 'admin.role.list'? 'active': '' }}">
